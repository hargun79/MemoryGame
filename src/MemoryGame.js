...
export default class MemoryGame extends Component {
  constructor(props) {
    ...
    let cards = [
      ...
      {id: 16, cardState: CardState.HIDING, backgroundColor: 'lime'},
      {id: 17, cardState: CardState.HIDING, backgroundColor: 'lime'},
      {id: 18, cardState: CardState.HIDING, backgroundColor: 'brown'},
      {id: 19, cardState: CardState.HIDING, backgroundColor: 'brown'},
      {id: 20, cardState: CardState.HIDING, backgroundColor: 'darkcyan'},
      {id: 21, cardState: CardState.HIDING, backgroundColor: 'darkcyan'},
      {id: 22, cardState: CardState.HIDING, backgroundColor: 'palevioletred'},
      {id: 23, cardState: CardState.HIDING, backgroundColor: 'palevioletred'}
    ];
    cards = shuffle(cards);
